...
namespace CosmosTime.UnitTests
{
    public class UnitTest1
    {
        ...
        public void UtcOffsetZoneTime_Parse2()
        {
            ...
            Assert.True(b3); // Z and tz conflict. Update: spec allows this  // https://datatracker.ietf.org/doc/draft-ietf-sedate-datetime-extended/
        ...
        public void UtcOffsetZoneTime_Parse()
        {
            ...
            Assert.Equal("2020-01-20T04:05:06.007Z[UTC]", p5.ToString());

            var b6 = ZoneTime.TryParse("2020-01-20T04:05:06.007-00:00[UTC]", out var p6);
            Assert.True(b6); // -00:00 ok
            Assert.Equal("2020-01-20T04:05:06.007Z[UTC]", p6.ToString());

            var b7 = ZoneTime.TryParse("2020-01-20T04:05:06.007[UTC]", out var p7);
            Assert.True(b7); // ok
            Assert.Equal("2020-01-20T04:05:06.007Z[UTC]", p7.ToString());
        }
        ...
        public void TzAndZ()
        {
            ...
            Assert.Equal("2022-07-08T02:14:07+02:00[Europe/Paris]", zt.ToString());
        }
        ...
        public void ClockTime_FromDateTime()
        {
            ...
            Assert.Equal(ctNow, ctUtcNow);
            Assert.Equal(ctUtcNow, ctUnspecNow);
        }
        ...
        public void MizzingTz()
        {
            ...
            {
                Assert.Equal(OffsetKind.Zulu, ok);
                return IanaTimeZone.GetTimeZoneInfo("Europe/Paris");
            });
            Assert.Equal("2022-07-08T02:14:07+02:00[Europe/Paris]", t.ToString());

            var t2 = ZoneTime.Parse("2022-07-08T00:14:07", (dto, ok) =>
            {
                Assert.Equal(OffsetKind.None, ok);
                return IanaTimeZone.GetTimeZoneInfo("Europe/Paris");
            });
