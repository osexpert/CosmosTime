# CosmosTime
	...
	var offsetTime = utcNow.ToOffsetTime(TimeSpan.FromHours(1));
	var londonZoneTime = utcNow.ToZoneTime(IanaTimeZone.GetTimeZoneInfo("Europe/London"));
	var londonClockTime = londonZoneTime.ToClockTime();
	var osloZoneTime = londonZoneTime.ToZoneTime(IanaTimeZone.GetTimeZoneInfo("Europe/Oslo"));
	var londonZoneTime_plus1Clock = londonZoneTime.AddClockHours(1);
	var londonZoneTime_plus1Utc = londonZoneTime.AddUtcHours(1);
