...
namespace CosmosTime.TimeZone
{
	...
	public static class IanaTimeZone
	{
		...
		static readonly Func<TimeZoneInfo, bool> _hasIanaId;
		...
		static IanaTimeZone()
		{
			...
			if (prop != null)
			{
				_hasIanaId = (Func<TimeZoneInfo, bool>)Delegate.CreateDelegate(typeof(Func<TimeZoneInfo, bool>), prop.GetGetMethod());
			}

		}

		//static readonly Lazy<bool> _tziSeemsToHavedIana = new Lazy<bool>(() =>
		//{
		//	try
		//	{
		//		_ = TimeZoneInfo.FindSystemTimeZoneById("Etc/UTC");
		...
		internal static IEnumerable<string> GetIanaIds()
			=> _ianaToWindows.Keys;

		internal static IEnumerable<string> GetWindowsIds()
			=> _windowsToIana.Keys;
